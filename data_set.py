...
face_cascade = cv2.CascadeClassifier(r'C:\Users\a2r0u\Desktop\face_recognition\haarcascade_frontalface_default.xml')

cap = cv2.VideoCapture(0)
path = (r"C:\Users\a2r0u\Desktop")# path were u want store the data set
